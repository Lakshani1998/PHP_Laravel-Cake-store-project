<nav class="sidebar sidebar-offcanvas" id="sidebar" >
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="">Add Inventory</a></li>
                <li class="nav-item"> <a class="nav-link" href="">View Available Inventory</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="index.html">
              ...
              <span class="menu-title" href="{{url('/login')}}">Log Out</span>
            </a>
          </li>
